...
// const Step2 = ({ formDataTo, handleChange }) => {
...
//   useEffect(()=> {
//     if (formDataTo.profileImage instanceof File) {
//       const reader = new FileReader();
//       reader.onloadend = () => { setProfileImgPreview(reader.result)};
//       reader.readAsDataURL(formDataTo.profileImage);
//     } else {
//       setProfileImgPreview(null);
//     }
//     if (formDataTo.idFrontImage instanceof File) {
//       const reader = new FileReader();
//       reader.onloadend = () => { setIdFrontPreview(reader.result)};
//       reader.readAsDataURL(formDataTo.idFrontImage);
//     } else {
//       setIdFrontPreview(null);
//     }
//     if (formDataTo.idBackImage instanceof File) {
//       const reader = new FileReader();
//       reader.onloadend = () => { setIdBackPreview(reader.result)};
//       reader.readAsDataURL(formDataTo.idBackImage);
//     } else {
