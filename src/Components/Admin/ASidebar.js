  ...
  const menuItems = [
    {
      ...
      href: `/AdminDashboard?${decodedToken._id}`,
    },
    {
      name: "Profiles",
      icon: require("../../Images/sidebar/profile.png"),
      href: `/AdminProfiles?${decodedToken._id}`,
    },
    {
      name: "Internship",
      icon: require("../../Images/sidebar/internship.png"),
      href: `/AdminInternships?${decodedToken._id}`,
    },
    {
      name: "Document",
      icon: require("../../Images/sidebar/Document.png"),
      href: `/AdminDocument?${decodedToken._id}`,
    },
    {
      name: "Calendar",
      icon: require("../../Images/sidebar/calender.png"),
      href: `/AdminCalender?${decodedToken._id}`,
    },
  ];
